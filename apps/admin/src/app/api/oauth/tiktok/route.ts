...
import { getConnectionStatus, disconnectTikTok } from '../../../../lib/oauth/tiktok';
...
export async function GET() {
  ...
  const oauthConfigured = Boolean(process.env.TIKTOK_APP_ID && process.env.TIKTOK_APP_SECRET);
...
export async function DELETE() {
  ...
  await disconnectTikTok(TENANT_ID);
